...
# 
# variant 1: for getting md output of code chunks
#  md_document:
#    variant: gfm
# variant 2: for getting output via prettydoc package
...
`r emo::ji("warning")` **Adding fonts to the sysfont database is only effective until the end of the session. It is therefore advisable to add the `font_add` commands to your kanjistat profile file; see the last section of this document.**
...
![](./figures/japanese_pets.svg){width=110%}
