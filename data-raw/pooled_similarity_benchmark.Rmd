...
results <- pooled_distance_benchmark(kanjidist_spec, 100)

df <- results

hist(unlist(df$jaccard), xlab="Jaccard Index, |A∩B| / |A∪B|", main="Jaccard Index of Most Similar Kanji as selected by Subjective \n Similarity Judgements vs. by the Similarity Metric")
```
